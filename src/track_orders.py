...
from src.analyze_log import top_order_per_costumer
from src.analyze_log import format_data, save_dishes, save_date
from src.analyze_log import never_ordered_per_costumer
from src.analyze_log import never_visited_per_costumer
...
class TrackOrders:
    ...
    def get_most_ordered_dish_per_costumer(self, costumer):
        return top_order_per_costumer(self._tracks, costumer)
