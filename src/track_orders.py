...
from src.analyze_log import never_visited
...
class TrackOrders:
    ...
    def get_never_ordered(self, costumer):
        return never_ordered(self._dishes, costumer, self._tracks)

    def get_days_never_visited(self, costumer):
